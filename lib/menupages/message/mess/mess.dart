...
class Mess extends StatelessWidget{
  Map child;
  Mess({super.key, required this.child});
  @override
  Widget build(BuildContext context) {

void _showAnimation(BuildContext context, img) {
  showDialog(
    ...
    return InkWell(
      onTapDown: (details) {
        ...
        _showAnimation(context,child["img"]);
  },
      child: Container(
        height: 61,
        child: Row(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(left: 12,top: 13.5,bottom: 13.5),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
