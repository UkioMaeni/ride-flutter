...
import 'package:flutter_application_1/menupages/search/UI/search_card/search_card.dart';
...
class ResultSearch extends StatefulWidget{
  ...
  ResultSearch({required this.from,required this.to,required this.date, super.key});
                              ...
                              return Padding(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(color: Color.fromRGBO(64,123,255,1))
                                  ),
                                  width: 91,
                                  height: 32,
                                  child: Text(
