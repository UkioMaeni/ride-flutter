...
class _CardOrderState extends State<CardOrder> {
  ...
  Widget build(BuildContext context) {
    ...
    DateTime dateTime = DateTime.fromMillisecondsSinceEpoch(widget.driverOrder.departureTime * 1000);
                        ...
                        children: [
                          Padding(
                            ...
                            child: Stack(
                              alignment: Alignment.center,
                              children: [
                                SvgPicture.asset("assets/svg/childSeats.svg",color:widget.driverOrder.preferences.childCarSeat?null:Color.fromRGBO(173,179,188,1) ,),
                                widget.driverOrder.preferences.childCarSeat?SizedBox.shrink():Icon(Icons.close,size: 30,weight: 2,color: Color.fromRGBO(173,179,188,0.7) ,)
                              ],
                            ),
                          ),
                          Padding(
                            ...
                            child: Stack(
                              alignment: Alignment.center,
                              children: [
                                SvgPicture.asset("assets/svg/animals.svg",color:widget.driverOrder.preferences.animals?null:Color.fromRGBO(173,179,188,1) ,),
                                widget.driverOrder.preferences.animals?SizedBox.shrink():Icon(Icons.close,size: 30,weight: 2,color: Color.fromRGBO(173,179,188,0.7) ,)
                              ],
                            ),
                          ),
                          Padding(
                            ...
                            child: Stack(
                              alignment: Alignment.center,
                              children: [
                                SvgPicture.asset("assets/svg/luggage.svg",color:widget.driverOrder.preferences.luggage?null:Color.fromRGBO(173,179,188,1) ,),
                                widget.driverOrder.preferences.luggage?SizedBox.shrink():Icon(Icons.close,size: 30,weight: 2,color: Color.fromRGBO(173,179,188,0.7) ,)
                              ],
                            ),
                          ),
                          Padding(
                            ...
                            child: Stack(
                              alignment: Alignment.center,
                              children: [
                                SvgPicture.asset("assets/svg/smoking.svg",color:widget.driverOrder.preferences.smoking?null:Color.fromRGBO(173,179,188,1) ,),
                                widget.driverOrder.preferences.smoking?SizedBox.shrink():Icon(Icons.close,size: 30,weight: 2,color: Color.fromRGBO(173,179,188,0.7) ,)
                              ],
                            ),
                          ),
                        ],
