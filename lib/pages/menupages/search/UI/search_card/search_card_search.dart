...
import 'package:flutter_application_1/pages/order_page/order_page.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:intl/intl.dart';

class CardsearchOrderSearch extends StatefulWidget{
DriverOrderFind driverOrder;
CardsearchOrderSearch({required this.driverOrder, super.key});
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(builder: (context) => OrderPage(
                    clientId: widget.driverOrder.driverId,
