...
class UIMap extends StatefulWidget{
  ...
  Function update;
  String city;
   UIMap({required this.city, required this.update, required this.mapController, required this.latitude,required this.longitude, super.key});
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        onCameraIdle: () async{
         final ss=await widget._controller.getLatLng(const ScreenCoordinate(x: 0, y: 0));
         setState(() {
        ...
        Positioned(
          ...
          child: InkWell(
            onTap: (){
              DataCreate newDate=DataCreate(widget.city, latitudeRide, longitudeRide);
